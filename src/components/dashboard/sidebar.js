        ...
        return(
            <div className="section sidebar">
                ...
                <ul className="card z-depth-0">
                    <li>
                    <div className="card-title"><i className="material-icons">edit</i>Add Post</div>
                    <div className="card-content white">
                        <form onSubmit={this.handleSubmit}>
                        <label htmlFor="Image" className="btn blue z-depth-0 fileBtn">Upload File</label>
                        <input id="Image" type="file" accept="image/*" onChange={this.handleChangefile} />
                        {
